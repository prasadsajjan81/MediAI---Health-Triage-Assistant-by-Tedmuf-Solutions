  ...
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-start p-4 bg-slate-50 rounded-xl text-xs text-slate-500 border border-slate-200 mt-2">
         ...
         <p>Disclaimer: This analysis is generated by AI (Vishwasini - MediAI) and may contain errors. Do not rely on it for medical decisions. Always consult a qualified healthcare professional.</p>
      </div>
    </div>
  );
};
